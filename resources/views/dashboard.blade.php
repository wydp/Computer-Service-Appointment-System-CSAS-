...
<div class="grid grid-cols-4 gap-6 mb-8">
    ...
    <a href="{{ route('clients.index') }}" style="text-decoration:none;cursor:pointer;">
        <div class="card p-6 hover:shadow-md transition-shadow duration-150" style="cursor:pointer;min-height:200px;">
            <div style="display:flex;align-items:flex-start;justify-content:space-between;height:100%;">
                <div style="flex:1;">
                ...
                <div style="width:50px;height:50px;background:#F5F6F7;border:1px solid #ECECEC;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-left:12px;">
                    <svg style="width:24px;height:24px;color:#525252;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('appointments.index', ['status' => 'completed']) }}" style="text-decoration:none;cursor:pointer;">
        <div class="card p-6 hover:shadow-md transition-shadow duration-150" style="cursor:pointer;min-height:200px;">
            <div style="display:flex;align-items:flex-start;justify-content:space-between;height:100%;">
                ...
                <div style="width:50px;height:50px;background:#F0FDF4;border:1px solid #BBFB7D;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-left:12px;">
    ...
    <a href="{{ route('appointments.index', ['status' => 'cancelled']) }}" style="text-decoration:none;cursor:pointer;">
        <div class="card p-6 hover:shadow-md transition-shadow duration-150" style="cursor:pointer;min-height:200px;">
            <div style="display:flex;align-items:flex-start;justify-content:space-between;height:100%;">
                ...
                <div style="width:50px;height:50px;background:#FEF2F2;border:2px solid #DC2626;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-left:12px;">
                    <svg style="width:24px;height:24px;color:#DC2626;" fill="currentColor" viewBox="0 0 24 24">

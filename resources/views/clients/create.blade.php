    ...
    <div class="card p-7">
        ...
        <form method="POST" action="{{ route('clients.store') }}">
            ...
            <div style="margin-bottom:28px;">
                ...
                <textarea name="notes" rows="2" class="input" placeholder="Any additional information...">{{ old('notes') }}</textarea>
            </div>

            <div style="display:flex;gap:12px;padding-top:16px;border-top:1px solid #ECECEC;">
                <button type="submit" class="btn-primary px-6 py-2.5 text-sm font-medium">Save Client</button>

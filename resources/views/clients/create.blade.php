...
<div style="max-width:560px;">
    <div class="card p-6">
        <h2 style="font-size:16px;font-weight:600;color:#191919;margin-bottom:24px;">New Client</h2>
        <form method="POST" action="{{ route('clients.store') }}">
            ...
            <div style="display:flex;gap:10px;">
                <button type="submit" class="btn-primary px-5 py-2 text-sm font-medium">Save Client</button>
